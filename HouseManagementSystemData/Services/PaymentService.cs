...
/*
        public async Task Send(string notification)
        {
            ...
            *//*
            ...
            tRequest.Headers.Add(string.Format("Authorization: key={0}", "AAAATa7N_K0:APA91bEQXEsUn6U24Sg4P7KWYJYjHYwqI_FnY1uVAleu58xBhb-4HF04LLzr2MS-TZq4666_oxS6YCxMe1vEkvwxXSNAPSQcynJo03vbGHAyDrYR4Jtm8Bvh2m4Bu1R1FlI22V0DnQnp"));
